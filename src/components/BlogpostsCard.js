...
export default function BlogpostsCard() {
  ...
  return (
    <>
      <ul
        className="flex flex-wrap flex-row w-full max-w-[1130px] mx-auto justify-start"
      >
        {blogpost.length > 0 ? (
            ...
            <li className="w-full max-w-[350px] cursor-pointer" key={index}>
              <div className="max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div className="px-6 py-4">
                  ...
                  <p className="text-gray-700 text-base" style={{ visibility: 'hidden', height: '0', width: '0'}}>
                  {blog.content}
                  </p>
                </div>
