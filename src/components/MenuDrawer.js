  ...
  return (
    <div className="w-full">
        <ul className="relative text-slate-300 w-fit my-auto mr-auto ml-0 grid grid-cols-1 justify-start text-left gap-4 py-8 px-4">
            <li className="hidden cursor-pointer hover:border-b-2 border-b-slate-300 w-max font-normal uppercase text-2xl">
            ...
            <li className="cursor-pointer hover:border-b-2 border-b-slate-300 w-max font-normal uppercase text-2xl">Article</li>
        </ul>
        <ul className="relative text-slate-300 w-fit my-auto mr-auto ml-0 grid grid-cols-1 justify-start text-left gap-4 py-8 px-4">
            <li className="cursor-pointer hover:border-b-2 border-b-slate-300 w-max font-extralight text-xs">Privacy Policy</li>
            <li className="cursor-pointer hover:border-b-2 border-b-slate-300 w-max font-extralight text-xs">Contact</li>
        </ul>
        <ul className="invisible relative text-slate-300 w-fit my-auto mr-auto ml-0 grid grid-cols-1 justify-start text-left gap-4 py-8 px-4">
